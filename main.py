...
bbot = open("bbot.txt", "r", encoding="utf-8").read()
hyd = open("hyd.txt", "r", encoding="utf-8").read()
rab = open("rab.txt", "r", encoding="utf-8").read()
rabw = open("rabw.txt", "r", encoding="utf-8").read()
legal = open("legal.txt", "r", encoding="utf-8").read()
otz = open("otz.txt", "r", encoding="utf-8").read()
